...
export default class DeviceView extends Vue {
  ...
  private searchConfig: Array<object> = [
    ...
    { key: 'startTime', info: '请选择开始时间', label: '开始时间', isDateTime: true },
    { key: 'endTime', info: '请选择结束时间', label: '结束时间', isDateTime: true },
    { key: 'code', info: '请输入报警编码a', label: '报警编码' },
    { key: 'name', info: '请输入报警设备', label: '报警设备' }
  ]
...
<style scoped>
  .history-container >>> .ivu-table-tip{
    display: none;
  }
</style>
